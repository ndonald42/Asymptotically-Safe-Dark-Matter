...
def tev_equations(t, y):
    ...
    dg1_dt = factor * ((77/10) * g1**3)
    dg2_dt = factor * ((-7/6) * g2**3)
    dg3_dt = factor * (-7 * g3**3)
    dgB_dt = factor * ((298/27) * gB**3 + (77/6) * gB * g12**2 - (16/3) * gB**2 * g12)
    dg12_dt = factor * ((-16/5) * g1**2 * gB + (-16/3) * gB * g12**2 + (77/5) * g1**2 * g12 + 
                        (298/27) * gB**2 * g12 + (77/6) * g12**3)
    dyt_dt = factor * ((9/2) * yt**3 + (3/2) * yb**2 * yt + 3 * k1**2 * yt + 3 * k2**2 * yt + 
                       3 * k3**2 * yt - (17/20) * g1**2 * yt - (9/4) * g2**2 * yt - 
                       8 * g3**2 * yt - (2/3) * gB**2 * yt - (5/3) * gB * g12 * yt - 
                       (17/12) * g12**2 * yt)
    dyb_dt = factor * ((3/2) * yt**2 * yb + (9/2) * yb**3 + 3 * k1**2 * yb + 3 * k2**2 * yb + 
                       3 * k3**2 * yb - (1/4) * g1**2 * yb - (9/4) * g2**2 * yb - 
                       8 * g3**2 * yb - (2/3) * gB**2 * yb + (1/3) * gB * g12 * yb - 
                       (5/12) * g12**2 * yb)
    dy1_dt = factor * (7 * y1**3 + (1/2) * k1**2 * y1 + 3 * y2**2 * y1 + 3 * y3**2 * y1 - 
                       (9/10) * g1**2 * y1 - (9/2) * g2**2 * y1 - 3 * gB**2 * y1 + 
                       3 * gB * g12 * y1 - (3/2) * g12**2 * y1)
    dy2_dt = factor * (4 * y2**3 + k2**2 * y2 + 6 * y1**2 * y2 + 3 * y3**2 * y2 - 
                       (18/5) * g1**2 * y2 - 3 * gB**2 * y2 + 6 * gB * g12 * y2 - 
                       6 * g12**2 * y2)
    dy3_dt = factor * (4 * y3**3 + k3**2 * y3 + 6 * y1**2 * y3 + 3 * y2**2 * y3 - 
                       3 * gB**2 * y3)
    dk1_dt = factor * (3 * yt**2 * k1 + 3 * yb**2 * k1 + (1/2) * y1**2 * k1 + (9/2) * k1**3 + 
                       3 * k2**2 * k1 + 3 * k3**2 * k1 - (9/4) * g1**2 * k1 - 
                       (9/4) * g2**2 * k1 - (15/4) * g12**2 * k1)
    dk2_dt = factor * (3 * yt**2 * k2 + 3 * yb**2 * k2 + (1/2) * y2**2 * k2 + 3 * k1**2 * k2 + 
                       (9/2) * k2**3 + (3/2) * k3**2 * k2 - (9/4) * g1**2 * k2 - 
                       (9/4) * g2**2 * k2 - (15/4) * g12**2 * k2)
    dk3_dt = factor * (3 * yt**2 * k3 + 3 * yb**2 * k3 + (1/2) * y3**2 * k3 + 3 * k1**2 * k3 + 
                       (3/2) * k2**2 * k3 + (9/2) * k3**3 - (9/20) * g1**2 * k3 - 
                       (9/4) * g2**2 * k3 - (3/4) * g12**2 * k3)
    dL_dt = factor * (12 * L**2 + 2 * Lm**2 - (9/5) * g1**2 * L - 3 * g12**2 * L - 
    ...
    dLp_dt = factor * (10 * Lp**2 + 4 * Lm**2 - 12 * gB**2 * Lp + 12 * gB**4 + 
                       24 * y1**2 * Lp + 12 * y2**2 * Lp + 12 * y3**2 * Lp - 
                       24 * y1**4 - 12 * y2**4 - 12 * y3**4)
    dLm_dt = factor * (6 * L * Lm + 4 * Lm * Lp + 4 * Lm**2 - (9/10) * g1**2 * Lm - 
...
def planck_equations(t, y):
    ...
    dg1n_dt = factor * ((77/10) * g1n**3) - fg * g1n
    dg2n_dt = factor * ((-7/6) * g2n**3) - fg * g2n
    dg3n_dt = factor * (-7 * g3n**3) - fg * g3n
    dgBn_dt = factor * ((298/27) * gBn**3 + (77/6) * gBn * g12n**2 - (16/3) * gBn**2 * g12n) - fg * gBn
    dg12n_dt = factor * ((-16/5) * g1n**2 * gBn + (-16/3) * gBn * g12n**2 + (77/5) * g1n**2 * g12n + 
                         (298/27) * gBn**2 * g12n + (77/6) * g12n**3) - fg * g12n
    dytn_dt = factor * ((9/2) * ytn**3 + (3/2) * ybn**2 * ytn + 3 * k1n**2 * ytn + 3 * k2n**2 * ytn + 
                        3 * k3n**2 * ytn - (17/20) * g1n**2 * ytn - (9/4) * g2n**2 * ytn - 
                        8 * g3n**2 * ytn - (2/3) * gBn**2 * ytn - (5/3) * gBn * g12n * ytn - 
                        (17/12) * g12n**2 * ytn) - fy * ytn
    dybn_dt = factor * ((3/2) * ytn**2 * ybn + (9/2) * ybn**3 + 3 * k1n**2 * ybn + 3 * k2n**2 * ybn + 
                        3 * k3n**2 * ybn - (1/4) * g1n**2 * ybn - (9/4) * g2n**2 * ybn - 
                        8 * g3n**2 * ybn - (2/3) * gBn**2 * ybn + (1/3) * gBn * g12n * ybn - 
                        (5/12) * g12n**2 * ybn) - fy * ybn
    dy1n_dt = factor * (7 * y1n**3 + (1/2) * k1n**2 * y1n + 3 * y2n**2 * y1n + 3 * y3n**2 * y1n - 
                        (9/10) * g1n**2 * y1n - (9/2) * g2n**2 * y1n - 3 * gBn**2 * y1n + 
                        3 * gBn * g12n * y1n - (3/2) * g12n**2 * y1n) - fy * y1n
    dy2n_dt = factor * (4 * y2n**3 + k2n**2 * y2n + 6 * y1n**2 * y2n + 3 * y3n**2 * y2n - 
                        (18/5) * g1n**2 * y2n - 3 * gBn**2 * y2n + 6 * gBn * g12n * y2n - 
                        6 * g12n**2 * y2n) - fy * y2n
    dy3n_dt = factor * (4 * y3n**3 + k3n**2 * y3n + 6 * y1n**2 * y3n + 3 * y2n**2 * y3n - 
                        3 * gBn**2 * y3n) - fy * y3n
    dk1n_dt = factor * (3 * ytn**2 * k1n + 3 * ybn**2 * k1n + (1/2) * y1n**2 * k1n + (9/2) * k1n**3 + 
                        3 * k2n**2 * k1n + 3 * k3n**2 * k1n - (9/4) * g1n**2 * k1n - 
                        (9/4) * g2n**2 * k1n - (15/4) * g12n**2 * k1n) - fy * k1n
    dk2n_dt = factor * (3 * ytn**2 * k2n + 3 * ybn**2 * k2n + (1/2) * y2n**2 * k2n + 3 * k1n**2 * k2n + 
                        (9/2) * k2n**3 + (3/2) * k3n**2 * k2n - (9/4) * g1n**2 * k2n - 
                        (9/4) * g2n**2 * k2n - (15/4) * g12n**2 * k2n) - fy * k2n
    dk3n_dt = factor * (3 * ytn**2 * k3n + 3 * ybn**2 * k3n + (1/2) * y3n**2 * k3n + 3 * k1n**2 * k3n + 
                        (3/2) * k2n**2 * k3n + (9/2) * k3n**3 - (9/20) * g1n**2 * k3n - 
                        (9/4) * g2n**2 * k3n - (3/4) * g12n**2 * k3n) - fy * k3n
    dLn_dt = factor * (12 * Ln**2 + 2 * Lmn**2 - (9/5) * g1n**2 * Ln - 3 * g12n**2 * Ln - 
    ...
    dLpn_dt = factor * (10 * Lpn**2 + 4 * Lmn**2 - 12 * gBn**2 * Lpn + 12 * gBn**4 + 
                        24 * y1n**2 * Lpn + 12 * y2n**2 * Lpn + 12 * y3n**2 * Lpn - 
                        24 * y1n**4 - 12 * y2n**4 - 12 * y3n**4) - flam * Lpn
    dLmn_dt = factor * (6 * Ln * Lmn + 4 * Lmn * Lpn + 4 * Lmn**2 - (9/10) * g1n**2 * Lmn - 
...
tev_ic = [0.46738, 0.63829, 1.05737, 0.3, (16/77)*0.3, 
